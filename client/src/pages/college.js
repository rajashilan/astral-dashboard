        ...
        <div className="text-[16px] font-normal text-center text-[#A7AFC7] border-b border-[#A7AFC7]">
          <ul className="flex flex-wrap -mb-px">
            <li onClick={() => setTab("admins")}>
              <p className="cursor-pointer inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-[#DFE5F8] hover:[#DFE5F8] hover:">
                Manage Admins
              </p>
            </li>
            <li onClick={() => setTab("register")}>
              <p className="cursor-pointer inline-block p-4 text-[#DFE5F8] font-medium border-b-2 border-[#DFE5F8] rounded-t-lg active">
                Register an Admin
              </p>
            </li>
          </ul>
